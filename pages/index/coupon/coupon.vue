<template>
	<view class="bg-white" style="min-height: 100vh;">
		...
		<view v-show="loaded">
			<view class="page-bar">
				<view class="text-xl" style="font-weight: bold;">会员福利</view>
				<view class="text-sm" style="font-weight: bold;color: #71717a;margin-top: 12rpx;">BENEFITS</view>
			</view>
			<view class="container flex"
				style="justify-content: space-between;align-items: flex-end;margin-top: 50rpx;margin-bottom: 50rpx;">
				<view class="flex" style="padding-left: 30rpx;">
					<u-avatar :src="is_login ? userinfo.headimg || defaultAvatarUrl : app_logo" size="80rpx" />
					<view style="margin-left: 20rpx;">
						<view class="text-desc">您当前为</view>
						<view class="text-xl">{{ is_login ? userinfo.vip_name || '游客':'游客' }}</view>
					</view>
				</view>
				<view class="text-sm text-desc" @click="$globalJump2View('/pages/agreement/agreement?name=level_explain')">会员等级说明</view>
			</view>
